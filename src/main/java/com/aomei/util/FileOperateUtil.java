...
public class FileOperateUtil {
	 ...
	 * @throws Exception
	 */
	public static List<Map<String, Object>> upload(HttpServletRequest request,String relUploadDir,boolean isZip) throws Exception {
		...
		for (Iterator<Map.Entry<String, MultipartFile>> it = fileMap.entrySet()
			...
			if(isZip){
				...
				map.put(FileOperateUtil.SUFFIX, prefix);
			}
