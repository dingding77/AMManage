...
<form  id="form1" method="post">
    <TABLE class="customerTab" WIDTH="1100px" BORDER="0" ALIGN="CENTER" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#fff">
        <tr>
            <th>客户名称</th>
            <td colspan="3">
                <input type="text" value="${materials.mateSize}" name="materials.mateName"/>
            </td>
        </tr>
        <tr>
            <th>客户代码</th>
            <td colspan="3">
                <input type="text" value="${materials.mateSize}" name="materials.mateCode">
            </td>
        </tr>
        <tr>
            <th>地址</th>
            <td colspan="3">
                <input type="text" value="${materials.mateSize}" name="materials.mateType">
            </td>
        </tr>
        <tr>
            <th>联系人</th>
            <td colspan="3">
                <input type="text" value="${materials.mateSize}" name="materials.mateSize">
            </td>
        </tr>
    </TABLE>
